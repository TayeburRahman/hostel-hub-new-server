// Language: typescript
// Path: src\resources\meal\meal.controller.ts
...
export class MealController {
    ...
    async getMealsByUserAndDate(req: Request, res: Response) {
        const meals = await getMealsByUserAndDate(
            req.params.id,
            req.params.date
        );
        res.json(meals);
    ...
    async getMealsByHostelAndDate(req: Request, res: Response) {
        const meals = await getMealsByHostelAndDate(
            req.params.id,
            req.params.date
        );
        res.json(meals);
    ...
    async getMealsByUserAndMonth(req: Request, res: Response) {
        const meals = await getMealsByUserAndMonth(
            req.params.id,
            req.params.month
        );
        res.json(meals);
    ...
    async getMealsByUserAndYear(req: Request, res: Response) {
        const meals = await getMealsByUserAndYear(
            req.params.id,
            req.params.year
        );
        res.json(meals);
    ...
    async getMealsByHostelAndYear(req: Request, res: Response) {
        const meals = await getMealsByHostelAndYear(
            req.params.id,
            req.params.year
        );
        res.json(meals);
